plot4 <- function() {
    ...
    legend("topright", legend = c("Sub_Metering_1", "Sub_Metering_2", "Sub_Metering_3"), col= c("black", "red", "blue"),  lty = c(1,1,1), lwd = 1, bty = "n")
    
    plot(relevantData$DateTime, relevantData$Voltage, xlab = "datetime", ylab = "Voltage", type = "l")
    
    plot(relevantData$DateTime, relevantData$Global_reactive_power, xlab = "datetime", ylab = "Global_reactive_power", type = "l")
